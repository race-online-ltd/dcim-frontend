...
const RegisterAddressForm = () => {
  ...
  useEffect(() => {
    if (isEditMode) {
      const loadRegisterAddress = async () => {
        try {
  ...
  const handleChange = (e) => {
    ...
    setRegisterAddress((prev) => ({ ...prev, [name]: value }));
  };
  ...
  const formTitle = isEditMode ? 'Edit Register Address Details' : 'Register Address Registration';
  const formSubtitle = isEditMode
    ? 'Modify the existing Register Address details.'
    : 'Register a new Register Address.';
          ...
          <div className="form-title-group">
            <h1>
              <Button
                ...
                aria-label="Back to Register Address list"
              >
              </Button>
              {formTitle}
            </h1>
